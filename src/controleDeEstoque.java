...
public class controleDeEstoque {
	...
	public static void main(String[] args) {
		...
		/*
		 Método que possua os códigos de produtos em estoque "banco de dados"
		 Banco de Dados irá para o método 'Inserir' e para o 'Retirar',
		 sendo estes colocados na main, utilizado um ou outro dependendo da 
		 ação escolhida na tela de opções
		
		Tela de opções:
		Inserir
		- Inserir o código, nome e quantidade do produto 
		...
		//AINDA NÃO PUXEI OS MÉTODOS 'INSERIR' E 'RETIRAR', POIS NÃO DESENVOLVI NENHUM DELES
		//TENTE DEBUGAR PARA ENTENDER CADA AÇÃO QUE FOI COMPLETADA ATÉ AGORA
		...
		System.out.println("------------------------------");
		System.out.println("Indique a ação desejada:");
		System.out.println("------------------------------");
		...
		if(inserirRetirar == 1){
			System.out.println("Digite o código, nome e a quantidade  do produto a ser inserido, respectivamente: ");
			inserir = in.nextInt();
			nomeDoProduto = in.next();
			quantidadeDoProduto = in.nextInt();
			System.out.println("Confirme sua ação: S ou N");
...
//				estoqueNovo = ----- + quantidadeDoProduto;
				System.out.printf("A quantidade em estoque era de %d produtos\n "
						+ "A quantidade de produtos em estoque atualmente é de %d produtos", estoqueAntigo, estoqueNovo);
			}
			else{
...
//				inserirProduto();			
				...
				System.out.println("Digite o código, nome e a quantidade  do produto a ser retirado, respectivamente: ");
				retirar = in.nextInt();
				nomeDoProduto = in.next();
				quantidadeDoProduto = in.nextInt();
				System.out.println("Confirme sua ação: S ou N");
...
/*	A IDEIA É DE PUXAR O MÉTODO BANCO DE DADOS PARA 'INSERIR' E PARA 'RETIRAR', 
